...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(vec) == 3 * sizeof(int*), "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        {
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == 3 * sizeof(double*), "Fill in the correct value.");
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 3 * sizeof(char*), "Fill in the correct value.");
        {
